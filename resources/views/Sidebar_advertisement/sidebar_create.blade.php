    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card" style="padding-bottom:36px;">
                            <div class="card-body">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label for="formFile" class="form-label mt-0">Existing Image</label>
                                <div class="d-flex align items-center">
                                    <img src="{{ asset('uploads/users/')}}" name="Bottom_sidebar_ad" id="BottomImg" class="avatar avatar-lg cover-image"
                                        style="width:400px;">
                                </div>
                                <br>
