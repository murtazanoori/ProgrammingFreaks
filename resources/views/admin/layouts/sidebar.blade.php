            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('home.ad')}}">Main Advertisement</a></li>
                        <li><a href="{{route('sidebar.all')}}">View Sidebar Advertisement</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('category.all')}}">Main Categories</a></li>
                        <li><a href="{{route('sub_category.all')}}">Sub Categories</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('Post.all')}}">Show Posts</a></li>
